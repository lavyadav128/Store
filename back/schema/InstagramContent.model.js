...
const instagramContentSchema = new mongoose.Schema({
  ...
  // Meta needs a publicly retrievable image/video URL. The agent never
  // pretends it can publish without a compliant asset.
  assetUrl: { type: String, default: "" },
  assetSource: { type: String, enum: ["", "ai_image", "ai_video", "admin"], default: "" },
