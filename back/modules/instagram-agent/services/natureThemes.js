// natureThemes.js
// ─────────────────────────────────────────────────────────────
// Master Nature & Earth Cinematic Video Reels Theme Engine
// Covers 6 Breathtaking Nature Realms:
// 1. 🌌 Celestial & Aurora Night Skies
// 2. 🌊 Mystic Waterfalls, Lagoons & Ocean Abyss
// 3. 🌿 Enchanted Ancient Rainforests & Zen Groves
// 4. 🌸 Blooming Wildflower Valleys & Cherry Blossom Shrines
// 5. 🏔️ Majestic Alpine Summits & Golden Hour Canyons
// 6. ❄️ Frozen Glacial Wonders & Crystal Ice Caverns
// ─────────────────────────────────────────────────────────────

export const NATURE_THEMES = [
  // ─── 1. CELESTIAL & AURORA NIGHT SKIES ──────────────────────
  {
    id: "celestial_aurora_fjord",
    realm: "Celestial & Aurora",
    title: "Bioluminescent Aurora Borealis over Arctic Fjord",
    description: "Vibrant emerald and violet northern lights dancing across a starry celestial sky, reflected in the glass-still waters of an Arctic fjord surrounded by snow-capped peaks.",
...
Audio Direction: Ethereal ambient space pads, crystalline wind chimes, peaceful arctic wind.`,
    caption: `🌌 Nature's Greatest Light Show: The Aurora Borealis.

When solar winds collide with Earth's magnetic shield, the sky ignites in ribbons of emerald and violet fire. There is a sacred stillness in watching the universe paint the night.

✨ Take a deep breath and let the calm of nature reset your mind.

📌 Save this reel for your nightly meditation & relaxation.
💬 Which celestial phenomenon do you dream of seeing live? Let us know below! 👇`,
    hashtags: ["#naturelovers", "#auroraborealis", "#northernlights", "#earthfocus", "#naturephotography", "#reelsviral", "#earthpix", "#nightsky", "#beautifuldestinations", "#relaxingnature", "#4knature", "#planetearth"]
  },
  {
    id: "celestial_milky_way_peaks",
    realm: "Celestial & Aurora",
    title: "Milky Way Galaxy Rising Above Alpine Peaks",
    description: "Ultra-high definition view of the glowing galactic core of the Milky Way rising behind rugged alpine spires, with shooting stars streaking across the cosmic sky.",
...
Audio Direction: Soothing binaural ambient soundscape with gentle acoustic resonance.`,
    caption: `✨ Standing beneath billions of stars reminds us of the endless beauty of our universe.

The Milky Way core rising over towering alpine summits — a reminder that we are made of stardust and infinite possibilities.

🌿 Unplug for a moment and soak in the cosmic peace.

📌 Save this reel for late-night inspiration and tranquility.
💫 Drop a "✨" if you love stargazing!`,
    hashtags: ["#milkyway", "#stargazing", "#astrophotography", "#alps", "#cinematicnature", "#earthfocus", "#naturegram", "#peacefulmoments", "#relaxingvideos", "#earth_shotz", "#viralreels"]
  },

  // ─── 2. MYSTIC WATERFALLS & OCEAN ABYSS ─────────────────────
  {
    id: "water_emerald_jungle_cascade",
    realm: "Mystic Waters",
    title: "Hidden Emerald Jungle Waterfall & Glowing Pool",
    description: "A colossal cascading waterfall plunging through dense tropical rainforest into a crystal turquoise lagoon, with morning god-rays piercing through the jungle canopy mist.",
...
Audio Direction: Soothing natural waterfall rush layered with calming traditional flute resonance.`,
    caption: `🌊 The Healing Power of Flowing Water.

Deep within the ancient tropical rainforest lies an untouched emerald sanctuary. Water cleanses, calms, and constantly moves forward without force.

💧 Let go of what you cannot control and flow with life.

📌 Save this reel to bring instant peace and focus to your day!
🌿 Tag someone who needs a peaceful nature break right now!`,
    hashtags: ["#waterfalllovers", "#natureheal", "#tropicalparadise", "#earthfocus", "#relaxingwater", "#waterfallhike", "#cinematicreels", "#peacefulnature", "#beautifulplanet", "#discoverearth", "#naturephotography"]
  },
  {
    id: "water_bioluminescent_ocean_waves",
    realm: "Mystic Waters",
    title: "Bioluminescent Glowing Blue Ocean Waves at Midnight",
    description: "Electric blue bioluminescent waves crashing softly onto a dark sandy beach under a full moon, creating trails of glowing neon light with every shoreline break.",
...
Audio Direction: Soothing crystalline ambient music with echoing pure water droplets.`,
    caption: `❄️ Sculpted by Time: The Blue Ice Caves.

Inside the heart of a glacier, ancient compressed ice glows with an otherworldly sapphire brilliance. Nature is the ultimate artist.

💎 Take a peaceful moment to appreciate the wonders of our world.

📌 Save this reel to explore more of Earth's hidden marvels!
🧊 Drop an "❄️" if this looks unreal!`,
    hashtags: ["#icecave", "#glacier", "#iceland", "#frozenwonderland", "#earthfocus", "#naturephotography", "#earthpix", "#discoverearth", "#cinematicnature", "#beautifuldestinations", "#reelsnature"]
  },
];

export function getDailyNatureTheme(dayOffset = 0, realmCategory = null) {
  let filtered = NATURE_THEMES;
  if (realmCategory && realmCategory !== "All Realms" && realmCategory !== "all") {
    filtered = NATURE_THEMES.filter(
      (t) => t.realm.toLowerCase().includes(realmCategory.toLowerCase()) ||
             t.title.toLowerCase().includes(realmCategory.toLowerCase())
    );
