...
import auth from '../../auth/authh.js'; // Custom auth middleware for protecting routes
import requireAdmin from '../../../shared/middleware/requireAdmin.js';
import { cache, clearCache } from '../../../shared/middleware/cache.js'; // Redis caching
...
router.post('/admin', auth, async (req, res) => {
  try {
    const {
      ...
      price, redirectPath, whatYouLearn, examFocus, targetAudience, includedFeatures,
      isActive, sortOrder,
    } = req.body;
