...
publicRouter.post(
  ...
  async (req, res) => {
    try {
      ...
      const FailedPayment = (await import("../agents/revenue-recovery/schema/FailedPayment.model.js")).default;
      const { handlePaymentFailed } = await import("../agents/revenue-recovery/services/orchestrator.js");
