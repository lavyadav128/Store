    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .mobile-hamburger { animation: pulseGlow 3s ease-in-out infinite; }
        ...
        .mobile-drawer-avatar { animation: avatarPulse 3s ease-in-out infinite; }
        @keyframes onlineBounce {
          0%, 100% { transform: scale(1); }
          50%       { transform: scale(1.3); }
        }
        .online-dot-bounce { animation: onlineBounce 2.5s ease-in-out infinite; }
        .drawer-nav-item { transition: all 0.2s cubic-bezier(0.34,1.56,0.64,1) !important; }
        .drawer-nav-item:active { transform: scale(0.97) !important; }
        .mobile-logout-btn {
          position: relative;
          overflow: hidden;
          transition: all 0.25s ease !important;
        }
        .mobile-logout-btn:active { transform: scale(0.97) !important; }
        ...
        .mobile-logout-btn:active::after { opacity: 1; }
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
          ...
          <Box>
            <Typography sx={{
              ...
              fontSize: { xs: 16, sm: 18 }, color: "#1a1a2e",
              letterSpacing: "-0.5px", lineHeight: 1,
              display: { xs: "none", sm: "block" },
            }}>EduPortal</Typography>
            <Typography sx={{
              fontFamily: "'DM Sans', sans-serif", fontWeight: 400,
              fontSize: 10, color: "#c0c0cc", letterSpacing: "1.2px",
              textTransform: "uppercase", display: { xs: "none", sm: "block" }, mt: 0.2,
            }}>Learning Platform</Typography>
          </Box>
          <Box sx={{ display: { xs: "none", sm: "block" }, width: "1px", height: 28, background: "#ececec", mx: 0.5 }} />
          <Typography sx={{
            display: { xs: "none", sm: "block" }, fontFamily: "'DM Sans', sans-serif",
            fontWeight: 500, fontSize: 12.5, color: "#bbb", letterSpacing: "0.2px",
          }}>{timeLabel} ✦</Typography>
          <Typography sx={{
            display: { xs: "block", sm: "none" }, fontFamily: "'Playfair Display', serif",
            fontWeight: 800, fontSize: 17, color: "#1a1a2e", letterSpacing: "-0.5px", lineHeight: 1,
          }}>EduPortal</Typography>
        </Box>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
            {userName && (
              <Box sx={{
                ...
                px: 1.5, py: 0.7, borderRadius: "40px",
                border: "1.5px solid #ececec", background: "#fafafa",
                transition: "border-color 0.2s, box-shadow 0.2s",
                "&:hover": { borderColor: "#d0d0d0", boxShadow: "0 4px 14px rgba(0,0,0,0.06)" },
              }}>
                ...
                <Box>
                  <Typography sx={{
                    ...
                    fontSize: 13, color: "#1a1a2e", lineHeight: 1.1, whiteSpace: "nowrap",
                  }}>{displayName}</Typography>
                  <Typography sx={{
                    fontFamily: "'DM Sans', sans-serif", fontSize: 10,
                    color: "#bbb", lineHeight: 1, mt: 0.2,
                  }}>Student</Typography>
                </Box>
                <Box sx={{
                  width: 7, height: 7, borderRadius: "50%", background: "#2ecc71",
                  flexShrink: 0, boxShadow: "0 0 0 2px #fff, 0 0 0 3.5px #d4f5e2",
                }} />
              </Box>
            )}
        ...
        {isMobile && (
          <>
            {userName && (
              <Box className="mobile-avatar-pill" sx={{
                display: "flex", alignItems: "center", gap: 0.8,
                px: 1, py: 0.5, borderRadius: "30px",
                border: "1.5px solid #e8e8f0",
                background: "linear-gradient(135deg, #fafafa 0%, #f5f5f8 100%)",
                mr: 1, boxShadow: "0 2px 10px rgba(0,0,0,0.06)",
              }}>
                <Box sx={{
                ...
                <Typography sx={{
                  ...
                  color: "#1a1a2e", maxWidth: 90, overflow: "hidden",
                  textOverflow: "ellipsis", whiteSpace: "nowrap",
                }}>{displayName}</Typography>
                <Box className="online-dot-bounce" sx={{
                  width: 6, height: 6, borderRadius: "50%", background: "#2ecc71",
                  flexShrink: 0, boxShadow: "0 0 0 2px #fff, 0 0 4px #2ecc71",
                }} />
              </Box>
            )}
          </>
